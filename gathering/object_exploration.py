...
if __name__ == "__main__":
    ...
    for gripper_rotation in gripper_rotations:
        if gripper_rotation == "0":
            ...
            start_pos = 712.3, 377.45, 642.7, 0.10982, -0.6852, 0.71095, -0.1147  #ok    ## 0.122787803968973  -0.696364240320019   0.696364240320019  -0.122787803968973        
            restart_pos = 707., 388.66, 640.7, 0.11314, 0.71263, 0.68473, 0.10245  # ok   0.122787803968973  0.696364240320019   0.696364240320019  0.122787803968973
        elif gripper_rotation == "-20":
            start_pos = 953.6, 374.88, 637.5, 0.11982, 0.69448, -0.70019, -0.11514  # ok ## 0.122787803968973  0.696364240320019   -0.696364240320019  -0.122787803968973
            restart_pos = 955.6, 378.26, 636.5, 0.1289, -0.71015, -0.67992, 0.1295  # ok  0.122787803968973  -0.696364240320019   -0.696364240320019  0.122787803968973
