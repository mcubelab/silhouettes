...
def createCubeMarker2(offset=(0,0,0), marker_id = 0, rgba=(1,0,0,1), orientation=(0,0,0,1), scale=(0.1,0.1,0.1), frame_id="/map", ns = ''):
    marker = Marker()
    marker.header.frame_id = frame_id
    marker.type = marker.CUBE
    marker.id = marker_id
...
def createSphereMarker(offset=(0,0,0), marker_id = 0, rgba=(1,0,0,1), orientation=(0,0,0,1), scale=(0.1,0.1,0.1), frame_id="/map", ns = ''):
    marker = Marker()
    marker.header.frame_id = frame_id
...
def createPointMarker2(points, marker_id, namespace, rgba = None, pose=[0,0,0,0,0,0,1], frame_id = '/map'):
    marker = Marker()
    marker.header.frame_id = frame_id
    marker.type = marker.POINTS
    marker.scale.x = 0.003
...
# end = [x,y,z]
# color = [r,g,b,a]
def createArrowMarker(start, end, color, offset=(0,0,0), orientation=(0,0,0,1), frame_id = '/map', marker_id = 0, ns = ''):
    marker = Marker()
    marker.header.frame_id = frame_id
    marker.id = marker_id
    marker.ns = ns
